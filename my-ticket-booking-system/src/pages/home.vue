...
const cardList = [
  ...
  },
  {
    ...
    eventId: "2",
    description:
      "Disney is coming to townDisney is coming to townDisney is coming to townDisney is coming to townDisney is coming to townDisney is coming to townDisney is coming to townDisney is coming to townDisney is coming to town",
    date: "2023-09-15",
    time: "18:00 - 21:00",
  },
      ...
      <VCard>
        ...
        <VCardText class="card-description" style="font-size: 1.1rem">
          ...
          <div style="text-align: right">
            <VBtn :to="'/event-details/' + card.eventId"> View Details </VBtn>
          </div>
        </VCardText>
      </VCard>
    </VCol>
